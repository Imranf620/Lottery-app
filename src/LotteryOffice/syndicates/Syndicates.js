        ...
        <>
            ...
            <div className='container-fluid'>
                ...
                <div className="row syndicates_cantainer">
                    <div className="col-12 col-md-11 mx-auto bg-dark mb-4 card_data">
                        <div className="d-flex flex-column flex-md-row p-2">
                            ...
                            <div className="col-12 col-md-7">
                                <div className="d-flex flex-column flex-md-row">
                                    ...
                                    <div className="d-flex ms-2 justify-content-center text-center gap-3">
                                ...
                                <div className="d-flex justify-content-between mb-3">
                                    <div>
                                        <h4>50 games</h4>
                                        <Link to="" className='show'>Show numbers</Link>
                                        <i className="bi bi-caret-down-fill show cursor-pointer ms-2"></i>
                                    </div>
                                    <button type="button" className="button btn me-4">Add to cart</button>
                                </div>
                            </div>
                        </div>
                        <p className="mb-0 text-light p-2">50 standard games in the USA Mega Lotto</p>
                    </div>

                    <div className="col-12 col-md-11 mx-auto mb-4 bg-dark card_data p-4">
                        <div className="d-flex flex-column flex-md-row">
                        ...
                        <p className="mb-0 text-light">Guaranteed Mega automatically guarantees you the Mega Number for each game.</p>
                    </div>

                    <div className="col-12 col-md-11 mx-auto mb-4 bg-dark card_data">
                        <div className="d-flex flex-column flex-md-row">
                        ...
                        <p className="mb-0 text-light">50 standard games in the USA Power Lotto.</p>
                    </div>
                    ...
                    <div className="col-12 col-md-11 mx-auto mb-4 bg-dark card_data">
                        ...
                        <p className="mb-0 text-light">Guaranteed Power automatically guarantees you the Power Number for each game.</p>
                    </div>
