                ...
                <div className='col-12 col-md-10 mx-auto'>
                    <h4 className='mt-3'>Lotto Systems Available at The Lottery Office</h4>
                    {
                        countryTickets.map((value, index) => (
                            <div key={index} className='d-flex align-items-center text-center my-4 justify-content-between py-3 px-4 cursor-pointer rounded bg-dark instant1' onClick={() => document.location.href = '/play'}>
                                <div className='align-items-center d-flex '>
                                    <img src={value.image} className='w-25 h-25' alt='Logo' />
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>{value.countryName}</h4>
                                        <h2 className='text-light'>${value.pirce}</h2>
                                        <p className='linked'>Closes in: {value.closeTime}</p>
                                    </div>
                                </div>
                                <div >
                                    <button className='button btn '>Play now</button>
                                </div>
                            </div>
                        ))}
                ...
                <div className='col-12 col-md-11 mx-auto my-4'>
                    <div className='d-flex flex-column flex-md-row align-items-start'>
                        ...
                        <div className="col-12 col-md-10 mx-auto left_border p-2">
                            ...
                            <div className='usaLottoSystem rounded py-2 px-5 justify-content-between align-items-center my-4  d-flex bg-dark instant1'>
                                ...
                                <button className='button btn ' onClick={()=>document.location.href='/play'}>Play now</button>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div className='d-flex flex-column flex-md-row align-items-start'>
                        ...
                        <div className="col-12 col-md-10 mx-auto left_border p-2">
                               ...
                               <Link onClick={() => { handleShowTable('usaMegaLottoPrize') }}>See USA Mega Lotto Systems Prize Tables</Link>
                            {
                             ...
                             <div className=' rounded py-2 px-5 justify-content-between align-items-center my-4  d-flex bg-dark instant1'>
                                <img src='	https://www.lotteryoffice.com.au/assets/images/lottery-logos/us-powerball.png' className='w-16' alt='USA power lotto system' />
                    ...
                    <div className='d-flex flex-column flex-md-row align-items-start'>
                        ...
                        <div className="col-12 col-md-10 mx-auto left_border p-2">
                               ...
                               <Link onClick={() => { handleShowTable('europeanMillionLottoPrize') }}>See European Millions Lotto Systems Prize Tables</Link>
                            {
                             ...
                             <div className='bg-dark instant1 rounded py-2 px-5 justify-content-between align-items-center my-4  d-flex'>
