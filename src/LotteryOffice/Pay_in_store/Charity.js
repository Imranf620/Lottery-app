            ...
            <div className='row'>
                ...
                <div className='row bg6 '>
                    <div className='col-12 col-md-11 mx-auto justify-content-center align-items-center text-center  p-4'>
                        <h3 className='text-light'>Featured Donations</h3>
                        <div className='row my-4'>
                            <div className='col-12 col-md-4 my-2'>
                                <div className='d-flex p-3 rounded  bg-dark instant1'>
                                    ...
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>$5,000</h4>
                                        <h5 className='text-light'>NT - Lions Cancer Institute</h5>
                                        <p className='linked'>May 2024</p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-12 col-md-4 my-2 bg-dark rounded instant1'>
                                <div className='d-flex p-3 '>
                                    <img src='https://blog.lotteryoffice.com.au/wp-content/uploads/2024/06/Top_Blokes.jpg' className='w-25 h-25' alt='Logo' />
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>$20,000</h4>
                                        <h5 className='text-light'>QID - Top Blokes | Logans Legacy</h5>
                                        <p className='linked'>June 2024</p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-12 col-md-4 my-2'>
                                <div className='d-flex p-3 rounded bg-dark instant1'>
                                    ...
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>Abdul's Experience</h4>
                                        <h5 className='text-light'>QID - Gold Coast Hospital Foundation</h5>
                                        <p className='linked'>June 2024</p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-12 col-md-4 my-2'>
                                <div className='d-flex p-3 rounded bg-dark instant1'>
                                    ...
                                    <div className='text-st ms-3art'>
                                        <h4 className='linked'>50,000</h4>
                                        <h5 className='text-light'>NAFT - Never Alone, Fight Together</h5>
                                        <p className='linked'>March 2024</p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-12 col-md-4 my-2'>
                                <div className='d-flex p-3 rounded bg-dark instant1'>
                                    ...
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>25,000</h4>
                                        <h5 className='text-light'>QID - Australian Street Aid Project</h5>
                                        <p className='linked'>Februray 2024</p>
                                    </div>
                                </div>
                            </div>
                            <div className='col-12 col-md-4 my-2'>
                                <div className='d-flex p-3 rounded bg-dark instant1'>
                                    <img src='https://blog.lotteryoffice.com.au/wp-content/uploads/2024/06/GchFoundation.png' className='w-25 h-25' alt='Logo' />
                                    <div className='text-start ms-3'>
                                        <h4 className='linked'>Volunteer Day</h4>
                                        <h5 className='text-light'>Gold Coast Hospital Foundation</h5>
                                        <p className='linked'>Februray 2024</p>
                                    </div>
                                </div>
                            </div>
                ...
                <div className='row p-4 bg6'>
                    <h2 className='text-center mt-3 w-75 mx-auto fs-4 text-light'>We've decided to give back to our community through the establishment of The Lottery Office Charity Fund</h2>
                    <img src='https://www.lotteryoffice.com.au/Assets/images/charity/promo-banner.jpg' className='w-75 mx-auto rounded' alt='Charity Fund' />
                </div>

                <div className='text-center p-4 bg6'>
                    <h2 className='text-light'>Apply For Funding</h2>
                    <div className='col-10 mx-auto bg-dark instant1  p-3 p-md-5 mt-3 rounded'>
                        <p className='text-light'>To find out more about The Lottery Office Charitable and Community Benefits Fund and how you can apply for funding for a charitable organisation or project, please contact us today.</p>
