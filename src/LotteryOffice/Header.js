            ...
            <div className='row headerbg  '>
                <div className='col-12 col-md-10 mx-auto header p-2'>
                    <div className='d-flex justify-content-between align-items-center text-center' >
                        ...
                        {
                            cartitemsShow && (
                                <div className='cartItems bg-dark'>
                                    <i class="bi bi-cart2 ms-2 text-primary"></i>
                                    <p className='text-light'>Unfortunately, your cart is empty</p>
                                    <p className='text-light textSize'>Please add something to your cart</p>
