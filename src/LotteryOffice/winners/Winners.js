        ...
        <div className='container-fluid bg6'>
            ...
            <div className='row'>
                <div className='col-12 col-md-11 mx-auto p-3 mb-5'>
                    <h1 className='text-light'>Winners</h1>
                    <hr />
                    <div className='col-12 d-flex flex-column gap-2 p-4 flex-md-row bg-dark'>
                        <div className='col-12 col-md-8 mx-auto'>

                            <div className=' col-12 winnner-card rounded d-flex mt-5'>
                                <div className='p-4'>
                                    <p className='linked'>April 6, 2024</p>
                                    <hr />
                                    <h5 className='text-light'>VIC WINNER: Lucky Life Path Number Leads to $47,116 win!</h5>
                                    <Link to='/read-more' className='linked'>Read more</Link>
                                </div >
                                <div>
                            ...
                            <div className='col-12 mx-auto mt-5'>
                                {
                                    countryTickets.map((value,index)=>(
                                        <div key={index} className=' rounded winnner-card cursor-pointer p-2 mt-3 d-flex' onClick={()=>document.location.href='/play'}>
