...
const DownloadApp = () => {
    ...
    return (
        <div className='container-fluid'>
            ...
            <div className='row'>
                <div className='col-12 col-md-11 mx-auto py-4 justify-content-start features bg6 mt-2  pb-5'>
                    <h4 className='text-light my-5'>Get our lotto app to win from overseas lottery draws</h4>
                    <div className='d-flex flex-column flex-md-row  bg-dark instant1 rounded'>
                        ...
                        <div className='col-12 col-md-4 p-3 right-part'>
                            ...
                            <p>All your <Link to='/results' className='text-primary'>lottery results in one place</Link>  We publish the latest results shortly after the draw and notify you of any winnings.</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className='row'>
                <div className='col-12 col-md-11 mx-auto play-options bg6'>
                    <h4 className='text-light mb-5'>Play to win with our exciting game options!</h4>
                    <div className='d-flex flex-column flex-md-row mt-4 rounded instant1 bg-dark p-2'>
                        <div className='col-12 col-md-3 mx-auto'>
                            <h5 >Play <Link to='/syndicates' className='text-primary fs-6'>Syndicates</Link> for more chances to win</h5>
                            <img src='	https://www.lotteryoffice.com.au/assets/images/app/app-3.png' alt='Lottery office' />
                        </div>
                        <div className='col-12 col-md-3 mx-auto'>
                            <h5>Play <Link to='/combo' className='text-primary fs-6'>Combos</Link> with the potential to win billions!</h5>
            ...
            <div className='row'>
                <div className='col-12 col-md-11 mx-auto  p-5 bg6'>
                    <h4 className='text-light'>What do our players say about the best lotto app in Australia?</h4>
                    <div className='row mt-4 row-cols-1 row-cols-md-3 g-4'>

                        <div className='col mx-auto '>
                            <div className='p-2 rounded bg-dark ps-3 instant1 feature-card'>
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>McCodswollop</h4>
                                    <p className='linked'>12/12/2023</p>
                                </div>
                                <h5 className='linked'>Legit and Australian owned.</h5>
                                <p className='text-light'>Easy to use app gives you access to worldwide lotteries. I’ve also found the staff to be helpful and friendly. Definitely recommend</p>
                            </div>
                        </div>

                        <div className='col mx-auto '>
                            <div className='p-2 feature-card rounded rounded bg-dark ps-3 instant1'>
                                <div className='d-flex'>
                                    {Array.from({ length: 5 }, (_, index) => (
                                        <i key={index} className="bi bi-star-fill text-warning m-0 fs-4"></i>
                                    ))}
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>Camo_78</h4>
                                    <p className='linked'>1/10/2023</p>
                                </div>
                                <h5 className='linked'>App is easy to use & has a lot of features.</h5>
                                <p className='text-light'>Had some questions about lotto systems & support team got back to me straight away.</p>
                            </div>
                        </div>

                        <div className='col mx-auto '>
                            <div className='p-2 rounded bg-light feature-card rounded bg-dark ps-3 instant1'>
                                <div className='d-flex'>
                                    {Array.from({ length: 5 }, (_, index) => (
                                        <i key={index} className="bi bi-star-fill text-warning m-0 fs-4"></i>
                                    ))}
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>Paul</h4>
                                    <p className='linked'>21/9/2023</p>
                                </div>
                                <h5 className='linked'>Customer service is phenomenal - </h5>
                                <p className='text-light'>The ability to punt on overseas lottery is a welcome addition to any punters portfolio. We all know the chance of winning is extremely low but as they say you have to be in it to win it.</p>
                            </div>
                        </div>
                        ...
                        <div className='col mx-auto'>
                            <div className='p-2 rounded bg-light feature-card rounded bg-dark ps-3 instant1'>
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>Fabienne Bidaut</h4>
                                    <p className='linked'>17/01/2022</p>
                                </div>
                                <h5 className='linked'>Customer service is phenomenal -</h5>
                                <p className='text-light'>This is the best lotto app for android, I find it much easier to use than the lott app</p>
                            </div>
                        </div>
                        ...
                        <div className='col mx-auto'>
                            <div className='p-2 rounded bg-light feature-card rounded bg-dark ps-3 instant1'>
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>AUkeving</h4>
                                    <p className='linked'>16/06/2021</p>
                                </div>
                                <h5 className='linked'>Great App!</h5>
                                <p className='text-light'>Very easy to use, and a great way to get access into the big lotteries overseas. Highly recommended!</p>
                            </div>
                        </div>
                        ...
                        <div className='col mx-auto'>
                            <div className='p-2 rounded bg-light feature-card rounded bg-dark ps-3 instant1'>
                                ...
                                <div className='d-flex'>
                                    <h4 className='text-light'>Tyler.B.W</h4>
                                    <p className='linked'>14/05/2021</p>
                                </div>
                                <h5 className='linked'>Easy as</h5>
                                <p className='text-light'>Great app, easy as. Love the security from the lottery office</p>
                            </div>
                        </div>
