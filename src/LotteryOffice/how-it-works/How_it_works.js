    ...
    <div className='container-fluid'>
      ...
      <div className='row how-it-works-container'>
        ...
        <div className='col-12 col-md-11 mx-auto d-flex flex-column flex-md-row flex-wrap mb-5'>
          <div className='col-12 col-md-4 mx-auto p-2 justify-content-center text-center rounded mt-3 works-card bg-dark'>
          ...
          <div className='col-12 col-md-4 mx-auto mt-3 rounded works-card text-center bg-dark'>
            <div className=' p-2 '>
